...
public:
    ...
    struct Action1
    {
        template<typename EVT, class FSM, class SourceState, class TargetState>
    ...
    struct transition_table
        : mpl::vector<
              ...
              Row<State1, Event1, State2, Action1, Guard1>, Row<State2, Event2, State3, Action2, none>,
              Row<State3, Event3, State1, none, none>, Row<State1, Event2, State1, Action2, none>  // 内部转换
              >
    {
    };

    // 允许的事件替代方案（如果没有匹配的转换）
    template<typename FSM, class Event>
